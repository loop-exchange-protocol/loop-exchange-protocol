...
通用 wire model 还定义 reference 与 mirrored。当前 Go Engine/Provider API 已提供实验实现，但不改变 Production CLI 的 embedded-only 命令面和 conformance；选择规则见 [Distribution 指南](docs/distributions.md)。
